...
"}")
        ...
        self.comments_likes_btn = QtWidgets.QPushButton(self.frame)
        self.comments_likes_btn.setMinimumSize(QtCore.QSize(200, 50))
        self.comments_likes_btn.setObjectName("comments_likes_btn")
        self.verticalLayout.addWidget(self.comments_likes_btn)
        ...
        self.groups_btn = QtWidgets.QPushButton(self.frame)
        self.groups_btn.setMinimumSize(QtCore.QSize(200, 50))
        ...
        self.return_btn.setMinimumSize(QtCore.QSize(200, 30))
        self.return_btn.setMaximumSize(QtCore.QSize(150, 16777215))
        ...
        self.comments_error_lbl = QtWidgets.QLabel(self.frame_12)
        self.comments_error_lbl.setMinimumSize(QtCore.QSize(0, 50))
        self.comments_error_lbl.setText("")
        self.comments_error_lbl.setObjectName("comments_error_lbl")
        self.horizontalLayout_10.addWidget(self.comments_error_lbl)
        ...
        self.likes_error_lbl = QtWidgets.QLabel(self.frame_16)
        self.likes_error_lbl.setMinimumSize(QtCore.QSize(0, 50))
        self.likes_error_lbl.setText("")
        self.likes_error_lbl.setObjectName("likes_error_lbl")
        self.horizontalLayout_14.addWidget(self.likes_error_lbl)
        ...
        self.comments_likes_error_lbl = QtWidgets.QLabel(self.frame_18)
        self.comments_likes_error_lbl.setText("")
        self.comments_likes_error_lbl.setObjectName("comments_likes_error_lbl")
        self.horizontalLayout_16.addWidget(self.comments_likes_error_lbl)
        ...
        self.page_folllowing_error_lbl = QtWidgets.QLabel(self.frame_19)
        self.page_folllowing_error_lbl.setMinimumSize(QtCore.QSize(0, 50))
        self.page_folllowing_error_lbl.setText("")
        self.page_folllowing_error_lbl.setObjectName("page_folllowing_error_lbl")
        self.horizontalLayout_23.addWidget(self.page_folllowing_error_lbl)
        ...
        self.groups_friends_btn = QtWidgets.QPushButton(self.frame_32)
        self.groups_friends_btn.setMinimumSize(QtCore.QSize(100, 40))
        self.groups_friends_btn.setObjectName("groups_friends_btn")
        self.verticalLayout_7.addWidget(self.groups_friends_btn)
        self.groups_comms_likes_btn = QtWidgets.QPushButton(self.frame_32)
        self.groups_comms_likes_btn.setMinimumSize(QtCore.QSize(0, 40))
        self.groups_comms_likes_btn.setObjectName("groups_comms_likes_btn")
        ...
        self.label_31.setMinimumSize(QtCore.QSize(200, 50))
        self.label_31.setObjectName("label_31")
        self.horizontalLayout_21.addWidget(self.label_31)
        self.adapter_name_txt = QtWidgets.QLineEdit(self.frame_25)
        self.adapter_name_txt.setMinimumSize(QtCore.QSize(300, 50))
        self.adapter_name_txt.setObjectName("adapter_name_txt")
        ...
        self.adapter_type_comboBox = QtWidgets.QComboBox(self.frame_25)
        self.adapter_type_comboBox.setMinimumSize(QtCore.QSize(200, 50))
        self.adapter_type_comboBox.setObjectName("adapter_type_comboBox")
        ...
        self.line_3 = QtWidgets.QFrame(self.frame_41)
...
"Likes"))
        ...
        self.groups_friends_btn.setText(_translate("MainWindow", "Friends"))
        self.groups_comms_likes_btn.setText(_translate("MainWindow", "Comments\n"
"and\n"
"Likes"))
        ...
        self.label_31.setText(_translate("MainWindow", "Adapter name"))
        self.label_33.setText(_translate("MainWindow", "Adapter type"))
        self.adapter_type_comboBox.setItemText(0, _translate("MainWindow", "Ethernet"))
        self.adapter_type_comboBox.setItemText(1, _translate("MainWindow", "Wi-Fi"))
